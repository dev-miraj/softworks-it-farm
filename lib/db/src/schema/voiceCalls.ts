...
export const voiceCallConfigsTable = pgTable("voice_call_configs", {
  ...
  ttsVoice: text("tts_voice").default("bn-BD-NabanitaNeural"),
  ttsGender: text("tts_gender").default("female"),
  ttsEmotion: text("tts_emotion").default("polite"),
  ttsLanguage: text("tts_language").default("bn-BD"),
  ttsStyle: text("tts_style").default("professional"),
